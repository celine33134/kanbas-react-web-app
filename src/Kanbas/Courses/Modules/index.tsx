...
//                 <ControlButtons
//                     id={module._id}
//                     deleteItem={(moduleId) => removeModule(moduleId)}
//                     editItem={(moduleId) => dispatch(editModule(moduleId))}
//                 />
                ...
                {modules.map((module: any) => (
                    <li key={module._id} className="wd-module list-group-item p-0 mb-5 fs-5 border-gray">
                        <div className="wd-title p-3 ps-2 bg-secondary">
                            ...
                            {/*/>*/}
                            <ControlButtons
                                id={module._id}            // Pass the module's ID
                                deleteItem={() => removeModule(module._id)} // Pass the delete function
                                editItem={() => dispatch(editModule(module._id))} // Pass the edit function
                            />
                        </div>
