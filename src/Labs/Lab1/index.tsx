...
//         // Your logic to handle the password change
//         console.log(e.target.value);
//     };
//
//     // Handler function for genre select (single)
//     const handleGenreChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
//         // Your logic to handle the genre selection
//         console.log(e.target.value);
//     };
//
//     // Handler function for genre select (multiple)
//     const handleMultipleGenresChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
//         // Your logic to handle multiple genre selections
...
//                     <input id="wd-text-fields-username" placeholder="jdoe" /> <br />
//                     <label htmlFor="wd-text-fields-password">Password:</label>
//                     <input type="password" id="wd-text-fields-password" value="123@#$asd" onChange={handlePasswordChange} />
//                     <br />
//                     <label htmlFor="wd-text-fields-first-name">First name:</label>
//                     <input type="text" id="wd-text-fields-first-name" title="John" /> <br />
//                     <label htmlFor="wd-text-fields-last-name">Last name:</label>
...
//             <label>Favorite movie genre (single selection):</label><br />
//             <select id="wd-select-one-genre" value="COMEDY" onChange={handleGenreChange}>
//                 <option value="COMEDY">Comedy</option>
//                 <option value="DRAMA">Drama</option>
...
//             </select><br />
//
//             <label>Favorite movie genres (multiple selection):</label><br />
//             <select id="wd-select-multiple-genres" multiple onChange={handleMultipleGenresChange}>
//                 <option value="COMEDY">Comedy</option>
//                 <option value="DRAMA">Drama</option>
//                 <option value="SCIFI">Science Fiction</option>
//                 <option value="FANTASY">Fantasy</option>
