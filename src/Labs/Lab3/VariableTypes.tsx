// JavaScript declares several datatypes such as Number,
// String, Date, and so on. To practice with variable types,
// create the VariableTypes component shown below
// and import it at the bottom of the Lab3 component.
